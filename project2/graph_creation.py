...
class MovieNetwork:
    ...
    def create_graph(self):
        ...
        #example graph looks like:
          ...
          #    'nm8742830': {},
          #    'nm6225202': {}}
        nodes = list(self.name_movie_dict.keys())
        ...
        for i in range(len(nodes)):
            for j in range(i + 1, len(nodes)):
                ...
                movies1 = set(self.name_movie_dict[n1])
                movies2 = set(self.name_movie_dict[n2])

                common = movies1.intersection(movies2)
                weight = len(common)

                #debug statement
                #if weight > 2:
                #    print("EDGE:", n1, n2, weight)

                if weight > 2:
                    self.add_edge(n1, n2, self.nconst_ar_dr, weight)
