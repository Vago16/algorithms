...
from graph_algorithms import bfs, dfs, dijkstra, kosaraju, tarjan, a_star
...
def testcase_4_1():
    ...
    if(len(data["testcase_4"])==len(testcase_4_1)):
        print("\nTestCase 4_1 Passed")
    else:
...
def testcase_4_2():
    ...
    if(check_list_of_tuples_equality(testcase_4_2,data["testcase_4"])==True):
        print("\nTestCase 4_2 Passed")
    else:
        print("\nTestCase 4_2 Failed")
        f+=1
...
def testcase_5_1():
    global total
    global f
    # Get SCCs using Tarjan's Algorithm
    testcase_5_1 = tarjan(graph)

    # Check if the number of SCCs matches the expected number
    if len(data["testcase_5"]) == len(testcase_5_1):
        print("\nTestCase 5_1 Passed")
    else:
        print("\nTotal number of strongly connected components for TestCase 5_1 is Incorrect")
        f += 1
    total += 1
...
def testcase_5_2():
    ...
    global f
    # Get SCCs using Tarjan's Algorithm
    testcase_5_2 = tarjan(graph)

    # Compare the SCCs found with the expected data
    if check_list_of_tuples_equality(testcase_5_2, data["testcase_5"]):
        print("\nTestCase 5_2 Passed")
    else:
        print("\nTestCase 5_2 Failed")
        f += 1
...
def testcase_6_1():
    global total
    global f
    # Run the A* algorithm with the given start and goal nodes (string identifiers)
    testcase_6_1 = a_star(graph, "nm0465106", "nm8270051")

    # Check if the result matches the expected data from `data["testcase_5_1"]`
    if data["testcase_6_1"] == testcase_6_1:
        print("\nTestCase 6_1 Passed")
    else:
        print("\nTestCase 6_1 Failed")
        f += 1
...
def testcase_6_2():
    ...
    global f
    # Run the A* algorithm with the given start and goal nodes (string identifiers)
    testcase_6_2 = a_star(graph, "nm8706223", "nm4655646")

    # Check if the result matches the expected data from `data["testcase_5_1"]`
    if data["testcase_6_2"] == testcase_6_2:
        print("\nTestCase 6_2 Passed")
    else:
        print("\nTestCase 6_2 Failed")
        f += 1
...
def testcase_6_3():
    ...
    global f
    # Run the A* algorithm with the given start and goal nodes (string identifiers)
    testcase_6_3 = a_star(graph, "nm5829291", "nm6074853")

    # Check if the result matches the expected data from `data["testcase_5_1"]`
    if data["testcase_6_3"] == testcase_6_3:
        print("\nTestCase 6_3 Passed")
    else:
        print("\nTestCase 6_3 Failed")
        f += 1
